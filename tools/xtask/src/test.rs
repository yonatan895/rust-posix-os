...
fn test_signal_delivery_and_sigreturn() {
    ...
    // 1. Range consistency tests: SIG_MIN..=SIG_MAX (1..=31)
    ...
    // 4. Default disposition termination simulation: kill(pid, SIGTERM)
    ...
    // 5. User signal handler stack frame construction and sigreturn restoration
    ...
    // Simulate deliver_signal_to_user
    let frame_size = core::mem::size_of::<SignalFrame>();
    let signal_rsp = (regs.rsp.saturating_sub(frame_size)) & !0xF;
    ...
    // Verify redirected registers for user handler execution
    regs.rsp = signal_rsp;
    ...
    // Simulate SYS_RT_SIGRETURN execution
    ...
    regs.r11 = frame.r11 as usize; // Restored RFLAGS
